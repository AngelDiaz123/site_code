...
many error ▌▒▒▒▒▒▒▀▀▀▒▒▒▒▒▒░▒░▒░▒░▒▒▒▌
	...
	*/
	...
	if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['message']) && isset($_POST['g-recaptcha-response'])) {
		...
		// Validate captcha
		$data = [
			'secret' => '6LdBjAsUAAAAAPhDsHFx85o1yVN1x89cavnlsPvf',
			'response' => $captcha,
		...
		if (isset($response->success) && $response->success) {
			...
			$confirmationHeaders .= 'From: Angel Diaz <noreply@angelldiaz.com>'.$rn;
			...
			mail($email, 'Angel Diaz - Contact Confirmation', $confirmationMsg, $confirmationHeaders);
			...
			$headers .= 'To: Angel Diaz <Angel.L.Diaz123@gmail.com>'.$rn;
